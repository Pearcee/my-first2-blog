...
#$infile = "K:\Doc\Images\18 Wilson Drive.jpg"
#$outfile = "K:\Doc\CBLImages\kitten2.jpg"
#Resize-Image -InputFile $infile -OutputFile $outfile -Width 640 -Height 480 
clear

$outdir = "A:\GIT\djangogirls\pages\static\css\"
#md $outdir
$indir = "A:\GIT\djangogirls\pages\static\css\images"
$collection = Get-ChildItem -Path "A:\GIT\djangogirls\pages\static\css\images\*.jpg"
$scale = 20

foreach ($item in $collection)
{
    $outfile = $outdir+$item.name
    $infile = $item
    Resize-Image -InputFile $infile -OutputFile $outfile -Scale $scale # -Width 640 -Height 480 
}